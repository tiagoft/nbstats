...
setup(
    ...
    description="Participation statistics for student notebooks",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/tiagoft/nbstats",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'nbstats-cli={MODULE_SLUG}.main:app',
        ],
    },
